...
execute join(['function! vital#_clap_filesalt#System#Job#Neovim#import() abort', printf("return map({'is_available': '', 'start': ''}, \"vital#_clap_filesalt#function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
delfunction s:_SID
" ___vital___
